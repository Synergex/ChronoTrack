...
{
/// <summary>
/// Synergy DataTable Wrapper for Project
/// </summary>
	[Serializable]
	public class ProjectDT : System.Data.DataTable
	{
		...
		/// </summary>
		public ProjectDT(SerializationInfo si, StreamingContext sc)
		{
			this.TableName = "SynDataTable Project";
			DataTable tdt = this;
			Project.TableHeader(ref tdt);
		...
		{
			DataTable tdt = this;
			Project.FillDataTable(al, ref tdt, "A", 0);
		}
	 
		/// <summary>
		/// Get a Structure from a table
		/// </summary>
		public void GetRow(ref Project str, int pos)
		{
			Project.GetRow(ref str, pos, this);
		}
		...
		/// </summary>
		public void AddRow(Project str)
		{
			DataTable tdt = this;
			ArrayList al = new ArrayList();
			al.Add(str);
		...
		/// </summary>
		public void AddRow(Project str, int pos)
		{
			DataTable tdt = this;
			ArrayList al = new ArrayList();
			al.Add(str);
			Project.FillDataTable(al, ref tdt, "I", pos);
		}
