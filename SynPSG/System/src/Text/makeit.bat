...
set NAMESPACE=SynPSG-System-Text
set SYNDEFNS=SynPSG.System.Text
...
set LINKERFLAGS=
:debug_mode
if EXIST C:\Development\SynPSG\System\lib\SynPSGSystemText.olb del /F /Q C:\Development\SynPSG\System\lib\SynPSGSystemText.olb
if EXIST C:\Development\SynPSG\System\obj\Text\SynPSGSystemText.dbo del /F /Q C:\Development\SynPSG\System\obj\Text\SynPSGSystemText.dbo
if EXIST C:\Development\SynPSG\System\obj\Text\ASCIIEncoding.dbo del /F /Q C:\Development\SynPSG\System\obj\Text\ASCIIEncoding.dbo
if EXIST C:\Development\SynPSG\System\hdr\%NAMESPACE%-ASCIIEncoding.dbh del /F /Q C:\Development\SynPSG\System\hdr\%NAMESPACE%-ASCIIEncoding.dbh
...
:main_line
@echo on
dblproto %VARIANT_FLAGS%  SRC:ASCIIEncoding.dbc
dbl %COMPILEFLAGS% -TX -WD=919 %VARIANT_FLAGS% -o OBJ:SynPSGSystemText.dbo  SRC:ASCIIEncoding.dbc
dblibr -ca OLIB:SynPSGSystemText.olb OBJ:SynPSGSystemText.dbo
dblink %LINKERFLAGS% -l EXE:SynPSGSystemText.elb OLIB:SynPSGSystemText.olb
endlocal
