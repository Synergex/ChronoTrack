...
{
/// <summary>
/// Synergy DataTable Wrapper for Country
/// </summary>
	[Serializable]
	public class CountryDT : System.Data.DataTable
	{
		...
		/// </summary>
		public CountryDT(SerializationInfo si, StreamingContext sc)
		{
			this.TableName = "SynDataTable Country";
			DataTable tdt = this;
			Country.TableHeader(ref tdt);
		...
		{
			DataTable tdt = this;
			Country.FillDataTable(al, ref tdt, "A", 0);
		}
	 
		/// <summary>
		/// Get a Structure from a table
		/// </summary>
		public void GetRow(ref Country str, int pos)
		{
			Country.GetRow(ref str, pos, this);
		}
		...
		/// </summary>
		public void AddRow(Country str)
		{
			DataTable tdt = this;
			ArrayList al = new ArrayList();
			al.Add(str);
		...
		/// </summary>
		public void AddRow(Country str, int pos)
		{
			DataTable tdt = this;
			ArrayList al = new ArrayList();
			al.Add(str);
			Country.FillDataTable(al, ref tdt, "I", pos);
		}
