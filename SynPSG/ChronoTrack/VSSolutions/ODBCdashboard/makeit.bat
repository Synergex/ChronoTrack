...
call devenv C:\Development\SynPSG\ChronoTrack\VSSolutions\ODBCdashboard\ODBCdashboard.sln /clean "%CONFIGURATION%|Any CPU"
call devenv C:\Development\SynPSG\ChronoTrack\VSSolutions\ODBCdashboard\ODBCdashboard.sln /build "%CONFIGURATION%|Any CPU"
