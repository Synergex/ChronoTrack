...
public partial class controls_selectors_ConsultantProjectCombo : System.Web.UI.UserControl
{
    ...
    public void DoBinding(string ConsultantId)
    {
    ...
    //Enable the control and select the last item if it contains items
    public void SelectLastIfItems()
    {
        if (comboBox.Items.Count > 0)
        {
            comboBox.Enabled = true;
