...
echo Rebuilding ChronoTrack Web Server
call devenv C:\Development\SynPSG\ChronoTrack\VSSolutions\ChronoTrackWS\ChronoTrackWS.sln /clean "%CONFIGURATION%|Any CPU"
call devenv C:\Development\SynPSG\ChronoTrack\VSSolutions\ChronoTrackWS\ChronoTrackWS.sln /build "%CONFIGURATION%|Any CPU"
