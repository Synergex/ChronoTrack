...
{
/// <summary>
/// Synergy DataTable Wrapper for Customer
/// </summary>
	[Serializable]
	public class CustomerDT : System.Data.DataTable
	{
		...
		/// </summary>
		public CustomerDT(SerializationInfo si, StreamingContext sc)
		{
			this.TableName = "SynDataTable Customer";
			DataTable tdt = this;
			Customer.TableHeader(ref tdt);
		...
		{
			DataTable tdt = this;
			Customer.FillDataTable(al, ref tdt, "A", 0);
		}
	 
		/// <summary>
		/// Get a Structure from a table
		/// </summary>
		public void GetRow(ref Customer str, int pos)
		{
			Customer.GetRow(ref str, pos, this);
		}
		...
		public ArrayList GetRows()
		{
			...
			for (int i = 0; i < this.Rows.Count; i++)
			{
			     ...
			     Customer.GetRow(ref str, i, this);
			     al.Add(str);
			}
			return al;
		}
		...
		/// </summary>
		public void AddRow(Customer str)
		{
			DataTable tdt = this;
			ArrayList al = new ArrayList();
			al.Add(str);
		...
		/// </summary>
		public void AddRow(Customer str, int pos)
		{
			DataTable tdt = this;
			ArrayList al = new ArrayList();
			al.Add(str);
			Customer.FillDataTable(al, ref tdt, "I", pos);
		}
