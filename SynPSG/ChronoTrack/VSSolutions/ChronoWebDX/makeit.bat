...
echo Rebuilding ChronoTrack web assembly
call devenv C:\Development\SynPSG\ChronoTrack\VSSolutions\ChronoWebDX.sln /clean "%CONFIGURATION%|Any CPU"
call devenv C:\Development\SynPSG\ChronoTrack\VSSolutions\ChronoWebDX.sln /build "%CONFIGURATION%|Any CPU"
