...
{
/// <summary>
/// Synergy DataTable Wrapper for Request
/// </summary>
	[Serializable]
	public class RequestDT : System.Data.DataTable
	{
		...
		/// </summary>
		public RequestDT(SerializationInfo si, StreamingContext sc)
		{
			this.TableName = "SynDataTable Request";
			DataTable tdt = this;
			Request.TableHeader(ref tdt);
		...
		{
			DataTable tdt = this;
			Request.FillDataTable(al, ref tdt, "A", 0);
		}
	 
		/// <summary>
		/// Get a Structure from a table
		/// </summary>
		public void GetRow(ref Request str, int pos)
		{
			Request.GetRow(ref str, pos, this);
		}
		...
		/// </summary>
		public void AddRow(Request str)
		{
			DataTable tdt = this;
			ArrayList al = new ArrayList();
			al.Add(str);
		...
		/// </summary>
		public void AddRow(Request str, int pos)
		{
			DataTable tdt = this;
			ArrayList al = new ArrayList();
			al.Add(str);
			Request.FillDataTable(al, ref tdt, "I", pos);
		}
